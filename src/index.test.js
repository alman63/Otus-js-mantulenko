...
describe('getPath', () => {
    ...
    it(`HTMLElement = ul  <body><div><ul></div></body>  
    return BODY > DIV > UL`, () => {
        document.body.innerHTML = '<div><ul></ul></div>';
        const element = document.querySelector('ul');
        expect(getPath(element)).toBe('BODY > DIV > UL');
    });
    it(`HTMLElement = ul and class  
    <body><div  class=test ><ul></div></body>  
    return BODY > DIV.test > UL`, () => {
        document.body.innerHTML = '<div class=test ><ul></ul></div>';
        const element = document.querySelector('ul');
        expect(getPath(element)).toBe('BODY > DIV.test > UL');
    });
    it(`HTMLElement = li:nth-child(2) and 
    <body><div  class=test ><ul><li>1</li>
    <li>2</li></ul></div></body>  
    return BODY > DIV.test > UL > li:nth-child(2)`, () => {
        document.body.innerHTML = `<div  class=test >
                <ul>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
